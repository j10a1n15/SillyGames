...
class EventHandler<T : SillyEvent>(private val logger: Logger) {

    private val listeners: MutableList<Listener> = mutableListOf()
    private var lastCancellableIndex: Int = -1

    fun register(method: Method, instance: Any, options: Subscribe) {
    ...
    private data class Listener(val options: Subscribe, val consumer: Consumer<Any>)
}
